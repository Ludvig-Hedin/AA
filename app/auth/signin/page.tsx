...
import { MessageSquare, ArrowLeft, Mail, Lock } from 'lucide-react';
...
export default function SignIn() {
  const { signIn, signInWithGoogle, signInWithApple, signInWithMicrosoft, loading } = useAuth();
        ...
        <div className="bg-card p-8 rounded-lg shadow-sm border">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              ...
              <Button variant="outline" onClick={() => signInWithMicrosoft()} disabled={loading}>
                <svg className="h-5 w-5" viewBox="0 0 24 24">
